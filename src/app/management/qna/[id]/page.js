...
export default function QnaDetailPage() {
  ...
  useEffect(() => {
    ...
    // 게시글 상세 불러오기
    fetch(`http://15.164.98.31:8080/api/management/qna/detail/${id}`, {
      headers: {
    ...
    // 댓글 리스트 불러오기
    fetch(`http://15.164.98.31:8080/api/management/qna/${id}/comment/list`, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    })
  ...
  const handleDeletePost = () => {
    ...
    fetch(`http://15.164.98.31:8080/api/management/qna/${id}`, {
      method: "DELETE",
  ...
  const handleUpdatePost = async () => {
    ...
    try {
      const res = await fetch(
        `http://15.164.98.31:8080/api/management/qna/${post.id}`,
        {
          method: "PUT",
          headers: {
  ...
  const handleCommentSubmit = () => {
    ...
    fetch(`http://15.164.98.31:8080/api/management/qna/${id}/comment`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${token}`,
  ...
  const saveEditing = (commentId) => {
    ...
    setCommentLoading(true);
    fetch(
      `http://15.164.98.31:8080/api/management/qna/${id}/comment/${commentId}`,
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
